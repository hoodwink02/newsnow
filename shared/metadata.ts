...
export const fixedColumnIdSet: Set<ColumnID> = new Set(fixedColumnIds)
export const hiddenColumns = Object.keys(columns).filter(id => !fixedColumnIdSet.has(id as ColumnID)) as HiddenColumnID[]
